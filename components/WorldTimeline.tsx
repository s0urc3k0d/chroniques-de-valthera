...
const WorldTimeline: React.FC<WorldTimelineProps> = ({
  ...
  const importanceStyles = {
    minor: 'border-slate-600 bg-slate-800/50',
    ...
    <div className={`relative flex ${isLeft ? 'md:justify-start' : 'md:justify-end'}`}>
      ...
      >
        <div className={`
          ...
          hover:border-valthera-500/50 hover:bg-slate-800/80
        `}>
          {/* Année */}
          ...
          {/* Titre */}
          <h4 className="text-lg font-bold text-white group-hover:text-valthera-400 transition-colors flex items-center gap-2">
